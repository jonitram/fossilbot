...
void GetNextReport(USB_JoystickReport_Input_t* const ReportData) {
	...
	switch (state)
	{
		...
		case BREATHE:
			do_steps(wake_up_hang, ARRAY_SIZE(wake_up_hang), ReportData, RESTORE_FOSSIL);
			break;
		
		case RESTORE_FOSSIL:
			do_steps(restore_fossil_steps, ARRAY_SIZE(restore_fossil_steps), ReportData, RESTORE_FOSSIL);
			break;
